// src/app/rockets/[rocketName]/RocketDetailClientPage.tsx
"use client";
...
import { ExternalLink, CalendarDays, Tag, Flag, Power, Gauge, Building, CheckCircle, Info, ArrowLeft } from 'lucide-react';
...
interface RocketDetailClientPageProps {
  rocket: Rocket | undefined;
}

const RocketDetailClientPage: React.FC<RocketDetailClientPageProps> = ({ rocket }) => {
        ...
        <Card className="dark:bg-gray-800 bg-white shadow-lg border dark:border-gray-700/50">
          ...
          <CardContent className="text-center">
            <Button variant="outline" onClick={() => router.back()}>
              <ArrowLeft className="mr-2 h-4 w-4" /> Back to Rockets
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-indigo-900 to-black text-gray-100 py-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <Button variant="ghost" onClick={() => router.back()} className="mb-8 text-orange-300 hover:text-orange-200 hover:bg-gray-700/50">
          <ArrowLeft className="mr-2 h-5 w-5" /> Back to Rockets
        </Button>
...
export default RocketDetailClientPage;
