...
// Interface definitions (can also be in a shared types file)
...
interface SolarSystemDetailClientPageProps {
  solarBody: SolarBody | undefined;
  relevantMissions: Mission[] | undefined;
  relatedBodiesData: SolarBody[];
  siteUrl: string;
  solarBodyId: string;
}
...
const SolarSystemDetailClientPage: React.FC<SolarSystemDetailClientPageProps> = ({
  solarBody,
  relevantMissions,
  relatedBodiesData,
  // siteUrl, // No longer needed here for schema
  // solarBodyId // No longer needed here for schema
}) => {
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="lg:w-2/3 space-y-8">
            ...
            <Card className="bg-gray-800/60 dark:bg-black/70 border border-gray-700/50 dark:border-gray-800/60 shadow-xl">
              ...
              <CardContent className="text-gray-300 dark:text-gray-200 leading-relaxed prose prose-sm prose-invert max-w-none">
          ...
          {relatedBodiesData && relatedBodiesData.length > 0 && (
...
export default SolarSystemDetailClientPage;
